...
function Battle() {
    ...
    const rogue = new Character(/*activeCharacter ? activeCharacter: */"Dodger", 1, 20, 100, 100);
    const slime = new Character("Nice Slime", 1, (10*(1+(rogue.level/10))), (50*(1+(rogue.level/10))), (50*(1+(rogue.level/10))));
    ...
    async function combat() {
        ...
        try {
            ...
            console.log(`Your hitpoints ${rogue.currentHealth}`);
            setTurnbase(true);
        }
        catch(error) {
            console.log(error);
